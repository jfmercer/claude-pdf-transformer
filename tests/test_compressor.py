...
def test_not_found_error_includes_install_hint():
...
@gs_required
def test_real_ghostscript_shrinks_image_pdf(tmp_path):
    gs = find_ghostscript()
...
@gs_required
def test_real_ghostscript_rejects_corrupt_input(tmp_path):
    gs = find_ghostscript()
